                        ...
                        for image in os.listdir(images_dir):
                            if image.endswith(".jpg"):
                                try:
                                    ...
                                    myGt = np.asarray((list_of_points["tl"], list_of_points["tr"], list_of_points["br"], list_of_points["bl"]))
                                    ...
                                    # cv2.circle(img, tuple(br), 2, (0, 0, 255), 2)
                                    # cv2.circle(img, tuple(bl), 2, (255, 255, 0), 2)
                                    # cv2.imshow("im", img)
                                    # cv2.waitKey(0)
