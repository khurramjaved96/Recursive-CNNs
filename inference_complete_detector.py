...
experiment_names = "Evaluation-experiment-4"
...
# %%
dataset_val = dataprocessor.DatasetFactory.get_dataset(validation_dirs, dataset_type, "val.csv")
# %%
dataset_test = dataprocessor.DatasetFactory.get_dataset(validation_dirs, dataset_type, "test.csv")
# %%
# Fix the seed.
# seed = seed
...
model_data_dict=torch.load(r"C:\Users\isaac\PycharmProjects\document_localization\Recursive-CNNs\experiments2182024\light-donkey-15-Experiment-5_0\light-donkey-15-Experiment-5complete_document_resnet.pb", map_location='cpu')
myModel.load_state_dict(model_data_dict)
if cuda:
    myModel.cuda()
...
#     my_eval.evaluate(my_trainer.model, val_iterator, epoch, prefix="val_")
epoch=0
my_eval.evaluate(myModel, test_iterator, epoch, prefix="test_")
my_eval.evaluate(myModel, val_iterator, epoch, prefix="val_")
my_eval.evaluate(myModel, train_iterator, epoch, prefix="train_")
