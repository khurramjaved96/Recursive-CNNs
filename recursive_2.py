...
temp_size = h_pool3.get_shape()
temp_size = temp_size[1] * temp_size[2] * temp_size[3]
print ("Size = ", int(temp_size))
# In[ ]:

W_fc1 = weight_variable([int(temp_size), 256], name="W_fc1")
b_fc1 = bias_variable([256], name="b_fc1")

h_pool4_flat = tf.reshape(h_pool3, [-1, int(temp_size)])
...
W_fc2 = weight_variable([256, 2], name="W_fc2")
