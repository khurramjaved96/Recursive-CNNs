...
class detector:
    def __init__(self, trainDir, validateDir, checkpointDir, trainMode, noOfSteps, batchSize, verbose):
...
class documentDetector:
    def __init__(self, trainDir, validateDir, checkpointDir,trainMode,  noOfSteps=10000, batchSize=10, verbose=2):
        self.super(trainDir, validateDir, checkpointDir, trainMode, noOfSteps, batchSize, verbose)
    ...
    def setupModel(self):
        ...
        with tf.name_scope("Input"):
            ...
            self.x = x = tf.image.resize_images(inputImage, [32, 32])
        ...
        with tf.name_scope("Conv5"):
            ...
            h_conv5 = tf.nn.relu(conv2dBatchNorm(h_pool4, W_conv5, self.rainMode) + b_conv5)
...
class cornerDetector:
    def __init__(self, trainDir, validateDir, checkpointDir, noOfSteps=10000, batchSize=10, verbose=2):
        self.super(trainDir, validateDir, checkpointDir, noOfSteps, batchSize, verbose)
